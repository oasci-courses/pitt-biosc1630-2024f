...
-   **AI detection:**
    ...
    AI detection tools will not be used in any formal capacity for this course.

!!! danger
    During this class, we may use generative AI tools when given explicit permission when, where, and how these tools are permitted to be used.
    Generative AI tools are not permitted outside of these specified circumstances.
